...
export function KnowledgeView() {
  ...
  return (
    <div className="h-full flex flex-col p-6 lg:p-10 space-y-6 overflow-x-hidden bg-transparent relative pt-[80px] lg:pt-[100px]">
      ...
      <section className="flex-1 overflow-y-auto overflow-x-hidden custom-scrollbar pr-2 min-h-0">
          ...
          >
            ...
            <div className="flex items-center gap-3 relative z-10 pt-4">
               <button
                ...
                className="h-10 px-8 rounded-xl glass-liquid-convex text-black font-black uppercase tracking-widest text-[9px] hover:scale-105 transition-all shadow-xl font-outfit"
              >
                Resetuj filtry
              </button>
              <button
