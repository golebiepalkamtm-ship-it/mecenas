      ...
      <div className="max-w-4xl mx-auto text-center">
        ...
        >
          ...
          <LandingPortalButton
            ...
            className="w-full py-4 font-black uppercase tracking-[0.4em] text-xs flex items-center justify-center gap-3 relative z-20"
          >
            <Star size={14} className="landing-portal-cta__icon" fill="currentColor" />
            Rozpocznij Test
          </LandingPortalButton>
        </motion.div>
      </div>
