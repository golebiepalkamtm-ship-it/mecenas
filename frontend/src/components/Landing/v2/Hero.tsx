...
export const Hero = ({ onStartTrial }: { onStartTrial: () => void }) => {
  return (
    <section className="relative min-h-screen w-full flex flex-col items-start pt-0 pb-20 pl-10 pr-6 overflow-hidden bg-[#0f0f0f]">
      <div className="absolute inset-x-0 bottom-0 top-0 z-0" data-speed="0.6">
        <img 
          src="/Gemini_Generated_Image_57qibm57qibm57qi.png" 
          alt="LexMind AI - Intelligent Justice" 
      ...
      <div className="relative z-10 w-full flex flex-col md:flex-row items-start gap-20">
        <div className="flex-1 text-left relative pt-0">
          <div className="text-left">
            <motion.h1
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
              transition={{ duration: 0.8, ease: [0.16, 1, 0.3, 1] }}
              className="hero-title text-5xl md:text-8xl font-inter font-semibold tracking-tight leading-[1.1] mb-10 text-chameleon"
            >
            ...
            >
              <p className="text-base md:text-xl text-[#d1d5db] font-medium leading-relaxed mb-6 drop-shadow-md">
              ...
              <p className="text-base font-black uppercase tracking-[0.35em] text-[#9ca3af] italic drop-shadow-lg">
            ...
            >
              <motion.button
                ...
                className="group relative px-10 py-4 bg-white/5 text-[#9ca3af] font-black uppercase tracking-[0.3em] text-[12px] rounded-full overflow-hidden border border-white/20 hover:border-white transition-all duration-500"
              >
