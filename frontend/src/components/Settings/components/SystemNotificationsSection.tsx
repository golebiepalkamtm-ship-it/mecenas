...
function NotificationToggle({ label, active = false }: { label: string; active?: boolean }) {
  ...
  return (
    <div className="px-3 py-2 rounded-xl glass-prestige flex items-center justify-between hover:bg-white/10 transition-all cursor-pointer" onClick={() => setIsOn(!isOn)}>
