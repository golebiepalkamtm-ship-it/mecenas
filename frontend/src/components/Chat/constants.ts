...
export const BRAND_MAP: Record<string, BrandConfig> = {
  ...
  'GROQ': { icon: Zap, color: 'text-black', bg: 'bg-rose-500/5', border: 'border-rose-400/20', accent: 'rose' },
  'PERPLEXITY': { icon: Search, color: 'text-black', bg: 'bg-teal-500/5', border: 'border-teal-400/20', accent: 'teal' },
  'X-AI': { icon: Flame, color: 'text-black', bg: 'bg-white/5', border: 'border-white/20', accent: 'slate' },
  'TOGETHER': { icon: Activity, color: 'text-black', bg: 'bg-purple-500/5', border: 'border-purple-400/20', accent: 'purple' },
  'FIREWORKS': { icon: Sparkles, color: 'text-black', bg: 'bg-yellow-500/5', border: 'border-yellow-400/20', accent: 'yellow' },
};
