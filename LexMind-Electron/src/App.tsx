      ...
      <AnimatePresence>
        {showNav && (
          <motion.nav 
            ...
            className="fixed lg:relative inset-y-0 left-0 w-full xs:w-[300px] sm:w-[320px] lg:w-[300px] xl:w-[320px] lg:h-[calc(100%-2rem)] flex flex-col z-50 glass-prestige lg:rounded-[2.5rem] lg:my-4 lg:ml-4 shadow-[0_0_100px_rgba(0,0,0,0.9)] overflow-hidden bg-(--bg-top)"
          >
            {/* Subtle edge glow */}
