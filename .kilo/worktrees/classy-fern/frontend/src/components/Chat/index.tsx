          ...
          <div className="max-w-4xl mx-auto flex flex-col gap-3">
              ...
              <AnimatePresence>
                ...
                <div className="relative glass-prestige p-1 rounded-2xl bg-(--bg-top) border-(--gold-muted) shadow-xl flex items-end gap-1.5 group/input transition-all">
                  {/* Left Action: New Chat */}
                  <motion.button
                    onClick={() => { newChat(); setInput(''); setAttachments([]); }}
        ...
        {showModels && (
          ...
          >
            ...
            <div className="flex-1 overflow-y-auto px-2 space-y-0.5 py-2 custom-scrollbar">
              {(() => {
                const grouped = availableModels.reduce((acc: Record<string, Model[]>, m: Model) => {
                ...
                return (Object.entries(grouped) as [string, Model[]][]).map(([vendor, models]) => {
