...
1. **Fikcyjny incydent drogowy (prowokacja)**: Trzech nieumundurowanych funkcjonariuszy CBZC z Bydgoszczy zatrzymało kolegę oskarżonego pod sklepem w Lubaniu pod pretekstem rzekomego zarysowania ich pojazdu przez oskarżonego.
2. **Brutalne zatrzymanie w obecności 5-letniego dziecka**: Po przyjeździe oskarżonego z żoną i małoletnim synem Miłoszem (5 lat) w celu polubownego spisania oświadczenia sprawcy kolizji, funkcjonariusze bez uprzedniego wylegitymowania się rzucili oskarżonego i kolegę na samochód, wykręcili ręce i skuli w kajdanki.
3. **Bezprawny nacisk i groźby wobec żony (naruszenie art. 171 § 1 k.p.k.)**: Żona oskarżonego została rozdzielona od płaczącego dziecka i zastraszona (groźby odebrania dziecka przez opiekę społeczną oraz utraty pracy w banku), co zmusiło ją pod presją psychiczną do wskazania adresu remontowanego lokalu przy ul. Leśnej 25/4.
4. **Lokalizacja 1 — Dom rodziców (ul. Stawowa 6)**: Oskarżony dobrowolnie oświadczył, że posiada w domu rodziców śladowe ilości na własny użytek: ok. 0,5 g białego proszku oraz susz zielony „na lufkę” (ok. 0,2 g). Przeszukanie lokalu potwierdziło wyłącznie tę ilość.
5. **Lokalizacja 2 — Obiekt remontowany (ul. Leśna 25/4)**: Na miejscu budowy funkcjonariusze ujawnili legalnie nabyte odczynniki chemiczne i rozpuszczalniki oraz 3 kolby i zlewki w zmywarce. Na obiekcie **nie było żadnych narkotyków, gotowego produktu ani działającej linii produkcyjnej**.
...
```mermaid
graph TD
    A[Wnioski Dowodowe Obrony] --> B[Dowody z Dokumentów]
    A --> C[Dowody ze Świadków]
    A --> D[Dowody z Opinii i Ekspertyz]
    
    B --> B1[Historia zakupów i faktury Allegro.pl - legalny obrót]
    B --> B2[Zaświadczenia PZHGP - hodowla gołębi pocztowych]
    B --> B3[Dokumentacja remontowa lokalu ul. Leśna 25/4]
    B --> B4[Protokoły komisyjnego ważenia k. 157-162]
    
    C --> C1[Przesłuchanie małżonki Marii Kaźmierczak-Pałki]
    C --> C2[Przesłuchanie kolegi - okoliczności prowokacji pod sklepem]
    C --> C3[Przesłuchanie funkcjonariuszy CBZC na okoliczność zawyżenia wag]
    
    D --> D1[Opinia psychiatryczna z 16.08.2025 r. - diagnoza F19.2]
    D --> D2[Ewentualna uzupełniająca opinia biegłego chemika/toksykologa]
```
